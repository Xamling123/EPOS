...
export function WaiterLayout() {
    ...
    const navItems = [
        // Waiter main view is the Table Map
        { path: '/waiter/tables', label: 'Table Map', icon: Grid3X3 },
        { path: '/waiter/orders', label: 'Active Orders', icon: ClipboardList },
        // Reuse admin dashboard for reports/summary if needed, or create a specific one
    ...
    return (
        <div className="min-h-screen flex bg-secondary-950">
            {/* Sidebar */}
            <aside className={`
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="h-16 flex items-center justify-between px-4 border-b border-secondary-800">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-display font-bold text-white">Waiter Panel</span>
                        </div>
